...
contract("SupplyChain", function (accounts) {
  ...
  describe("Use cases", () => {
    ...
    it("should allow someone to purchase an item and update state accordingly", async () => {
      ...
      //console.log("look ", aliceBalanceBefore/1e18, bobBalanceBefore/1e18, excessAmount)
      ...
      const result = await instance.fetchItem.call(0);
      //console.log("look after ", aliceBalanceBefore, bobBalanceBefore, excessAmount, result[3].toString(10))
